    ...
    public static function matrix(): array
    {
        return [
            ...
            Role::ADMIN => [
                ...
                'matches',
                'conversations',
                'cases', 'claim_cases', 'close_cases', 'reassign_cases',
                ...
                'roles',
                'activity_log', 'export_audit_logs', 'message_access_log',
            ...
            Role::TS_LEAD => [
                ...
                'matches',
                'conversations', 'view_message_content',
                'message_access_log',
                'cases', 'claim_cases', 'close_cases', 'reassign_cases',
                'bans', 'warn_users', 'limit_users', 'shadow_ban_users', 'suspend_users',
                ...
                'activity_log', 'export_audit_logs',
